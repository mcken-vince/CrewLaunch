...
import { PackageModel, ClientModel, ContractModel, JobModel, CrewModel } from './Models-types';

const crewSchema: CrewModel = new mongoose.Schema({
  foreman_name: {
    type: String,
    required: true
  },
...
const clientSchema: ClientModel = new mongoose.Schema({
  name: {
    type: String,
    required: true,
  },
...
const packageSchema: PackageModel = new mongoose.Schema({
  title: {
    type: String,
    required: true
  },
...
const contractSchema: ContractModel = new mongoose.Schema({
  package_id: {
    type: String,
    required: true
  },
...
const jobSchema: JobModel = new mongoose.Schema({
  crew_id: {
    type: String,
    required: true
  },
