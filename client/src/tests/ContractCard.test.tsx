...
const contract = {
   "_id": "61787c58efa37244e2c35c13", "client_id": "616f7ceea703ecd4ec419646", "address": "177 Mornersome Drive SW, Calgary AB", "job_notes": "There are no notes. Nothing to see here.", "package_id": "616f7ceea703ecd4ec419647", "start_date": new Date("2021-10-28T06:00:00.000Z"),
...
const formattedDate: string = formatDate(new Date("2021-10-28T06:00:00.000Z"));
...
describe('<ContractCard />', () => {
  it('renders without crashing and displays contract details', () => {
    renderContractCard();
